...
var server = http.createServer(app)// Return a new web server object
var io = require('socket.io').listen(server);
var uuid = require('node-uuid');// Render Unique identify.
var Room = require('./room.js'); // My module
var _ = require('underscore')._; // Work with array

app.configure(function () {
    //app.set('port', process.env.OPENSHIFT_NODEJS_PORT || 7777);
    app.set('port', (process.env.PORT || 7777));
    //app.set('ipaddr', process.env.OPENSHIFT_NODEJS_IP || "192.168.3.73");
    app.set('ipaddr', process.env.IP || "192.168.3.73");
...
server.listen(app.get('port'), function () {
    console.log('ABCV Server listenning port ' + app.get('port'));
});
